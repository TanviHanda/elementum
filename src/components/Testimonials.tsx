  ...
  const imgs = [
    {
      ...
      className: "left-[15%] top-[14%] w-[70px] h-[70px]",
    },
    { src: "img6.png", className: "left-[15%] top-[45%] w-[116px] h-[116px]" },
    {
      src: "https://randomuser.me/api/portraits/men/75.jpg",
      className: "left-[9%] top-[75%] w-[55px] h-[55px]",
    },
    ...
    <section className="py-16 md:py-24 relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8">
        <div className="relative min-h-[auto] md:min-h-[520px]">
          ...
          {/* content */}
          <div
            className="relative z-10 text-center max-w-[700px] mx-auto reveal-item"
            data-reveal
          >
            <h2
              className="font-gerbil text-[30px] sm:text-[36px] md:text-[50px] leading-tight anim-text-rise"
              style={{ ["--text-delay" as string]: "220ms" }}
            >
              <span className="bg-[#D7EEDD] px-3 rounded-full">What</span> our
              customer <br />
              says{" "}
            ...
            {/* testimonial box */}
            <div
              className="mt-8 md:mt-10 bg-[#D7EEDD4D] rounded-[30px] px-5 py-7 md:px-10 md:py-10 max-w-[450px] mx-auto reveal-item hover-rise"
              data-reveal
              style={{ ["--reveal-delay" as string]: "320ms" }}
            >
              <p
                className="relative px-4 md:px-8 text-[11px] sm:text-[12px] md:text-[14px] text-gray-700 text-center leading-relaxed anim-text-rise"
                style={{ ["--text-delay" as string]: "420ms" }}
              >
                ...
                technologies which turned out to be reliable and easy to use and
                reliable
                <ImQuotesRight className="pointer-events-none absolute right-[11%] top-[75%] text-gray-300 text-2xl md:text-4xl" />
              </p>
            </div>
          </div>
        </div>
