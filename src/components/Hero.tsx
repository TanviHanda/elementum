  ...
  return (
    <section className="relative py-12 md:py-16 overflow-hidden" data-reveal>
      ...
      <div className="pointer-events-none absolute left-0 top-[70%] hidden -translate-y-1/2 lg:block">
        ...
        >
          <path
            d="M0 34C31 46 31 84 0 98S-10 126 0 132S31 184 0 198S-10 226 0 232"
            stroke="#FF8A95"
            strokeWidth="4"
            strokeLinecap="round"
          ...
          />
          <path
            d="M30 30C64 42 64 82 30 96C14 104 14 122 30 130C64 144 64 184 30 198C14 206 14 224 30"
            stroke="#1D1D1D"
            strokeWidth="4"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      {/* half circle shape */}
      <div className="hidden md:block w-32 h-16 bg-[#934CEC] rounded-t-full rotate-[130deg] absolute right-[2%] top-[45%]"></div>
      {/* main code  */}
      <div className="mx-auto max-w-[1200px] px-4 text-center md:px-8">
        <h1
          className="font-gerbil mx-auto max-w-[280px] sm:max-w-6xl text-[26px] sm:text-[40px] md:text-[72px] lg:text-[80px] xl:text-[88px] leading-[1.12] sm:leading-[1.05] tracking-[-0.03em] text-[#151515] anim-text-rise"
          style={{ ["--text-delay" as string]: "120ms" }}
        >
          The{" "}
          ...
          <span className="inline-block whitespace-nowrap bg-[#F5ACE1] px-2 md:px-5 rounded-full">
            changing
          </span>{" "}
          the{" "}
          <span className="inline-block whitespace-nowrap bg-[#CFE9D7] px-2 md:px-5 rounded-full">
            status
          </span>{" "}
          Quo with
        </h1>
        ...
        <p
          className="mt-5 text-[13px] md:text-[15px] text-[#5A5A5A] max-w-[640px] mx-auto px-2 md:px-0 anim-text-rise"
          style={{ ["--text-delay" as string]: "320ms" }}
        >
