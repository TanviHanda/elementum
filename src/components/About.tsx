export default function About() {
  return (
    <section className="py-16 md:py-28 relative overflow-hidden">
      ...
      {/* bg circle */}
      <div
        className="absolute left-1/2 top-0 -translate-x-1/2 w-[320px] h-[320px] md:w-[420px] md:h-[420px] rounded-full blur-2xl"
        style={{
          background:
            "radial-gradient(circle, rgba(210,98,112,0.5) 0%, rgba(255,255,255,0) 70%)",
        }}
      />
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8">
        <div className="relative z-10 grid md:grid-cols-2 gap-12 items-start md:items-center">
          ...
          >
            <h2
              className="font-gerbil text-[30px] sm:text-[34px] md:text-[50px] leading-tight anim-text-rise"
              style={{ ["--text-delay" as string]: "180ms" }}
            >
            ...
            <p
              className="mt-5 text-sm text-gray-600 max-w-[320px] anim-text-rise"
              style={{ ["--text-delay" as string]: "340ms" }}
            >
              We are a team of strategists, designers and researchers. We
              believe progress happens when you stop playing safe.
            </p>

            <a
              href="#"
              className="mt-4 inline-flex items-center gap-3 text-sm hover-rise"
            >
              Read more
          ...
          >
            ...
            <div className="mt-8 md:mt-10 max-w-[400px] mx-auto md:ml-auto">
              ...
              <p
                className="mt-5 text-sm text-gray-600 max-w-[360px] anim-text-rise"
